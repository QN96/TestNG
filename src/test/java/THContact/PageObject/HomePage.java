...
public class HomePage {
    ...
    static By menu_Contact=By.xpath("//span[text()='Clients']");
    ...
    public static WebElement menu_Contact(WebDriver driver) throws NoSuchElementException{
        try{
            element = driver.findElement(menu_Contact);
        }catch (Exception e){
            System.out.println("Exceptions Caught"+e.getMessage());
        }
        return element;
    ...
    public static void Home(WebDriver driver){
        ...
        HomePage.menu_Contact(driver).click();
    }
}
